...
public class LocationTest3Activity extends CheckPermissionsActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_test3);
